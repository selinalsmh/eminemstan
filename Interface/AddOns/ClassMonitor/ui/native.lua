...
local bordercolor = { .1,.1,.1 }-- { .6,.6,.6 }
local blank = [[Interface\BUTTONS\WHITE8X8]]--[[Interface\AddOns\ClassMonitor\medias\textures\normTex.tga]]
local normTex = [[Interface\AddOns\ClassMonitor\medias\textures\Statusbar]]
...
local function SetTemplate(f, t, tex)
	...
	if t == "Transparent" then backdropa = 0.7 else backdropa = 1 end
