...
L["Add Item"] = "添加项目" -- Needs review
L["Add Item / Search Term"] = "添加项目/搜索词" -- Needs review
-- L["Add item to dealfinding list"] = ""
-- L["Add Item to Dealfinding List"] = ""
L["Add Item to New List"] = "添加项目到新列表" -- Needs review
L["Add Item to Selected List"] = "添加项目到选中列表" -- Needs review
...
L["Copy the settings from one existing profile into the currently active profile."] = "从一个已有配置文件中复制设置到当前激活的配置" -- Needs review
-- L["Crafting Cost:"] = ""
-- L["Crafting Mats"] = ""
L["Create a new empty profile."] = "新建一个空白配置" -- Needs review
L["Current Profile:"] = "当前配置" -- Needs review
L["Data Imported to Group: %s"] = "数据导入到组：%s" -- Needs review
-- L["Dealfinding list deleted: \"%s\""] = ""
-- L["Dealfinding List Name"] = ""
-- L["Dealfinding Lists"] = ""
-- L["Dealfinding Search"] = ""
L["Default"] = "默认" -- Needs review
L["Default Undercut"] = "默认削价" -- Needs review
L["Delete a Profile"] = "删除一个配置" -- Needs review
L["Delete existing and unused profiles from the database to save space, and cleanup the SavedVariables file."] = "从数据库中删除已有未使用的配置文件已节省空间并清理保存变量文件" -- Needs review
L["Delete / Export List"] = "删除/导出列表" -- Needs review
L["Delete List"] = "删除列表" -- Needs review
...
L["Existing Profiles"] = "已有配置" -- Needs review
-- L["% Expected Cost"] = ""
-- L["Export List"] = ""
...
L["Imported List"] = "导入的列表" -- Needs review
L["Import List"] = "导入列表" -- Needs review
L["Import Shopping List"] = "导入购买列表" -- Needs review
-- L["Invalid Exact Only Filter"] = ""
-- L["Invalid Filter"] = ""
L["Invalid folder name. A folder with this name may already exist."] = "文件夹名称无效。可能已存在同名文件夹。" -- Needs review
-- L["Invalid Item Level"] = ""
-- L["Invalid Item Rarity"] = ""
-- L["Invalid Item SubType"] = ""
L["Invalid Item Type"] = "无效物品类型" -- Needs review
-- L["Invalid list name. A list with this name may already exist."] = ""
-- L["Invalid Min Level"] = ""
L["Invalid money format entered, should be \"#g#s#c\", \"25g4s50c\" is 25 gold, 4 silver, 50 copper."] = "输入的金币格式无效，应为\"#g#s#c\"， \"25g4s50c\"为25金4银50铜" -- Needs review
...
L["Milling"] = "研磨" -- Needs review
L["Mode:"] = "模式：" -- Needs review
-- L["Name of New List to Add Item to:"] = ""
-- L["Name of the new dealfinding list."] = ""
L["Name of the new shopping list."] = "新建购买列表的名称" -- Needs review
L["New"] = "新建" -- Needs review
...
-- L["Price Per Gem"] = ""
L["Price Per Ink"] = "墨水单价" -- Needs review
...
-- L["Rename List"] = ""
L["Reset Profile"] = "重置配置" -- Needs review
...
-- L["Select Mode"] = ""
L["Select Primary Filter"] = "选择主过滤器" -- Needs review
...
L["Shop for materials required by the Crafting queue."] = "购买制造队列缺少的材料" -- Needs review
...
L["The item you entered was invalid. See the tooltip for the \"%s\" editbox for info about how to add items."] = "你添加的物品无效.请查看\"%s\" 输入框关于如何添加物品的帮助." -- Needs review
...
L["You can either drag an item into this box, paste (shift click) an item link into this box, or enter an itemID."] = "你可以拖拽物品到此输入框，粘贴物品连接或者输入物品ID。" -- Needs review
