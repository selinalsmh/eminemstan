...
function Search:Minimize()
	if Search.searchBar.postFrame:IsVisible() then
		Search.searchBar.postFrame:Hide()
		Search.searchBar.postFrame.minimized = true
	else
		Search.searchBar.postFrame.minimized = nil
	end
end

function Search:Maximize()
	if Search.searchBar.postFrame.minimized then
		Search.searchBar.postFrame:Show()
	end
end
