...
function AuctionControl:Show(parent)
	...
	AuctionControl:RegisterMessage("TSM_QUICK_BUYOUT")
	diffFrame.num = 0
end

function AuctionControl:Hide()
	AuctionControl:UnregisterEvent("AUCTION_ITEM_LIST_UPDATE")
	AuctionControl:UnregisterMessage("TSM_QUICK_BUYOUT")
...
function AuctionControl:TSM_QUICK_BUYOUT()
	private:FindCurrentAuctionForBuyout()
	AuctionControl:SendMessage("TSM_SHOPPING_AH_EVENT", "Buyout")
end
