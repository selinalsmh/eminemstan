...
local cfg = {
	font =  "Fonts\\ARKai_T.TTF",--mediapath.."expressway.ttf",
	fontsize = 12, -- I'd suggest adjusting the scale instead of the fontsize
	outline = "OUTLINE",
	tex = mediapath.."texture",

	scale = 1.1,
	point = { "RIGHT", "RIGHT", -350, 200 }, -- use "/freebtip" instead
	cursor = false,
...
local function ShowTalents(self, unit)
	...
	if(self.freebTalent) then
		self:AddDoubleLine(talenttext, ("..."), nil, nil, nil, talentcolor.r, talentcolor.g, talentcolor.b)
		self.freebTalent = false
	end
