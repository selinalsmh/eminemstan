...
L["Could not find item's group."] = "Не удалось найти группу предмета."
...
L["Delete"] = "Удалить"
L["Delete All Groups In Category"] = "Удалить все группы в категории"
L["Delete all groups inside this category. This cannot be undone!"] = "Удалить все группы в категории. Невозможно отменить!"
...
L["Disables canceling of auctions which can not be reposted (ie the market price is below your threshold)."] = "Отключена отмена аукциона, которые не могут быть выставлены (на рынке цена ниже вашего порога)"
...
L["Enable All"] = "Разрешить всё"
L["Enable sounds"] = "Включить звуки."
L["Enter a filter into this box and click the button below it to cancel all of your auctions that contain that filter (without scanning)."] = "Введите фильтр и нажмите кнопку ниже, чтобы отменить все ваши аукционы которые содержат данный фильтр (без сканирования)."
L["Error with scan. Scanned item multiple times unexpectedly. You can try restarting the scan. Item:"] = "Ошибка сканирования. Отсканированный предмет появлялся несколько раз. Попробуйте еще раз провести сканирование:"
...
L["Fixed invalid groups."] = "Исправлены ошибочные группы."
L["Fix (Recommended)"] = "Исправить (Рекомендуется)"
L["General"] = "Общие"
...
L["How low the market can go before an item should no longer be posted. The minimum price you want to post an item for."] = "Нижняя граница, до которой может дойти рынок. Минимальная цена, по которой вы хотите продавать товар."
...
L["If checked, the items in this group will be included when running a reset scan and the reset scan options will be shown."] = "Если выбрано, предметы группы будут включены при запуске Повторного сканирования и  опции Повторного сканирования будут отображены."
L["If checked, will cancel auctions that can be reposted for a higher amount (ie you haven't been undercut and the auction you originally undercut has expired)."] = "Если выбрано, будут отменены аукционы, которые могут быть перевыставлены за бОльшую сумму (например, вам не сбили цену и аукцион, у которого вы первоначально сбивали цену, истек)." -- Needs review
L["If enabled, when the lowest auction is by somebody on your whitelist, it will post your auction at the same price. If disabled, it won't post the item at all."] = "Ели включено, то при низкой цене аукциона, если продавец в вашем \"белом списке\", то аукцион будет выставляться по данной цене. Если выключено , то предмет будет выставляться как все."
L["If enabled, when you create a new group, your bags will be scanned for items with names that include the name of the new group. If such items are found, they will be automatically added to the new group."] = "Если включено, то когда вы создаете новую группу, ваши сумки будут просканированы  для поиска предметов с именем новой группы.Если какие либо предметы будут найдены, они автоматически добавяться в новую группу."
...
L["Include in reset scan"] = "Включить в Сбрасывающий скан"
L["Info"] = "Инфо"
L["Invalid category name."] = "Неправильное имя категории."
L["Invalid group name."] = "Неправильное имя группы."
L["Invalid money format entered, should be \"#g#s#c\", \"25g4s50c\" is 25 gold, 4 silver, 50 copper."] = "Неверный формат, должно быть \"#g#s#c\", \"25g4s50c\" - 25 gold, 4 silver, 50 copper."
...
L["Invalid search term for group %s. Searching for items individually instead."] = "Неверная поисковая фраза для группы  %s. Поищите товары по отдельности."
L["Invalid seller data returned by server."] = "Сервер вернул неверные данные о продавце." -- Needs review
L["Item"] = "Товар"
L["Item failed to add to group."] = "Товар не удалось добавить в группу"
L["Item/Group is invalid."] = "Товар/Группа неверна."
L["Items in this group:"] = "Товары в этой группе:"
...
L["Items not in any group:"] = "Товары, не принадлежащие к группам:"
L["Items that are stacked beyond the set amount are ignored when calculating the lowest market price."] = "Связки товаров больше заданного значения игнорируются при подсчете минимальной рыночной цены."
-- L["Items to be added:"] = ""
L["Log Info:"] = "Лог:"
L["Long (12 hours)"] = "Длительный (12 часов)"
-- L["long (less than 12 hours)"] = ""
L["Lowest auction by whitelisted player."] = "Самые дешёвые лоты у игрока из белого списка." -- Needs review
L["Lowest Buyout"] = "Мин. выкуп"
L["Lowest Buyout:"] = "Мин. выкуп:"
L["Macro created and keybinding set!"] = "Макрос создан и назначен!"
L["Macro Help"] = "Помощь по макросам"
L["Make another after this one."] = "Сделать еще после этого."
L["Management"] = "Управление"
L["% Market Value"] = "% рыночной цены"
L["Match whitelist prices"] = "Сравнивать с ценой из белого списка" -- Needs review
-- L["Max Cost:"] = ""
...
-- L["Max Price Per:"] = ""
L["Max price per item"] = "Макс цена за 1 товар"
-- L["Max Quantity:"] = ""
L["Max quantity to buy"] = "Макс. качество для покупки" -- Needs review
L["Max reset cost"] = "Макс. стоимость перепродажи" -- Needs review
L["Max Scan Retries (Advanced)"] = "Макс кол-во попыток (Расширенная)"
L["Medium (2 hours)"] = "Среднее (2 часа)"
-- L["medium (less than 2 hours)"] = ""
L["Minimum Price Settings (Threshold)"] = "Настройки минимальной цены (границы рынка)"
-- L["Min Profit:"] = ""
L["Min reset profit"] = "Мин. прибыль от перепродажи" -- Needs review
L["Modifiers:"] = "Модификаторы:"
L["Must wait for scan to finish before starting to reset."] = "Нужно дождаться завершения сканирования прежде чем начинать перепродавать." -- Needs review
L["Name of New Group to Add Item to:"] = "Имя новой группы для добавления товара:"
...
L["Per auction"] = "Товаров на один лот"
...
L["Post Auctions"] = "Выставить"
L["Post cap"] = "Максимальное количество"
L["Posting at fallback."] = "Выставить по резервной цене"
-- L["Posting at reset price."] = ""
-- L["Posting at whitelisted player's price."] = ""
-- L["Posting at your current price."] = ""
L["Posting %s / %s"] = "Выставление %s / %s"
-- L["Posting this item."] = ""
L["Post Scan Finished"] = "Скан для выставления лотов окончен"
...
L["Price Per Stack"] = "Открыть главное окно программы"
L["Price resolution"] = "Ценовое решение"
-- L["Price resolution for fallback"] = ""
-- L["Price resolution for %s"] = ""
-- L["Price resolution for threshold"] = ""
L["Price threshold"] = "Ценовой порог"
L["Price to fallback too if there are no other auctions up, the lowest market price is too high."] = "Граничная цена, по которой выставляется товар, если нет других продавцов или минимальная рыночная цена слишком высокая."
...
L["Rename this category to something else!"] = "Переименуйте эту категорию по-другому!"
L["Rename this group to something else!"] = "Переименуйте эту группу по-другому!"
L["Reset Auctions"] = "Перепродажа лотов" -- Needs review
L["Reset Method"] = "Метод перепродажи" -- Needs review
L["Reset Profile"] = "Сброс профиля"
L["Reset Scan Finished"] = "Сканирование лотов на перепродажу завершено" -- Needs review
L["Reset Scan Settings"] = "Настройка перепродажи лотов" -- Needs review
L["Resets the price of items according to the rules setup in Auctioning by buying other's auctions and canceling your own as necessary."] = "Сбрасывает цену товаров в соответствии с правилами установленными в Auctioning по покупке других лотов и отменяет собственные при необходимости"
...
L["Right click to do a custom cancel scan."] = "ПКМ, чтобы выполнить выборочный скан на отмену" -- Needs review
L["Right click to do a custom post scan."] = "ПКМ, чтобы выполнить выборочный скан выставления" -- Needs review
L["Right click to do a custom reset scan."] = "GRV? чтобы выполнить выборочный скан на перепродажу" -- Needs review
...
L["Save New Price"] = "Сохранить новую цену"
L["Scanning"] = "Идёт сканирование"
L["Scanning Item %s / %s"] = "Сканирование товара %s / %s"
...
L["Short (30 minutes)"] = "Короткий (30 минут)" -- Needs review
L["short (less than 30 minutes)"] = "короткий (меньше 30 минут)."
L["Show All Auctions"] = "Показать все аукционы" -- Needs review
...
L["Total Cost"] = "Общая стоимость" -- Needs review
