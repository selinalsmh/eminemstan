...
L["Are you sure you want to delete the selected profile?"] = "Bist du sicher, dass du das ausgewählte Profil löschen möchtest?" -- Needs review
L["Are you SURE you want to delete this category?"] = "Bist du SICHER, dass du diese Kategorie löschen möchtest?" -- Needs review
L["Are you SURE you want to delete this group?"] = "Bist du SICHER, dass du diese Gruppe löschen möchtest?" -- Needs review
...
L["Items not in any group:"] = "Gegenst\\195\\164nde die keiner Gruppe angehören:" -- Needs review
L["Items that are stacked beyond the set amount are ignored when calculating the lowest market price."] = "Gegenst\\195\\164nde die zu größeren Pakten (Stacks) als das gesetzte Limit gestapelt sind werden bei der Berechnung des niedrigsten Marktpreises ignoriert." -- Needs review
-- L["Items to be added:"] = ""
L["Log Info:"] = "Log Informationen:" -- Needs review
L["Long (12 hours)"] = "Lang (12 Stunden)" -- Needs review
-- L["long (less than 12 hours)"] = ""
L["Lowest auction by whitelisted player."] = "Niedrigste Auktion nach Spielern auf der Whitelist" -- Needs review
L["Lowest Buyout"] = "Niedrigster Sofortkauf" -- Needs review
L["Lowest Buyout:"] = "Niedrigster Sofortkauf:" -- Needs review
L["Macro created and keybinding set!"] = "Macro erstellt und Tastenbelegung gesetzt!" -- Needs review
L["Macro Help"] = "Macro Hilfe"
L["Make another after this one."] = "Erstelle ein weiteres nach diesem." -- Needs review
L["Management"] = "Verwaltung" -- Needs review
L["% Market Value"] = "% des Marktwerts" -- Needs review
L["Match whitelist prices"] = "An Whitelist-Preis angleichen" -- Needs review
-- L["Max Cost:"] = ""
...
-- L["Max Price Per:"] = ""
L["Max price per item"] = "Maximaler Preis pro Gegenstand" -- Needs review
-- L["Max Quantity:"] = ""
L["Max quantity to buy"] = "Maximale Kaufmenge" -- Needs review
L["Max reset cost"] = "Max. reset Kosten" -- Needs review
L["Max Scan Retries (Advanced)"] = "Max Wiederholung des Scans (Erweitert)" -- Needs review
L["Medium (2 hours)"] = "Mittel (2 Stunden)" -- Needs review
...
-- L["Min Profit:"] = ""
L["Min reset profit"] = "Min. reset Profit" -- Needs review
L["Modifiers:"] = "Modifikator" -- Needs review
L["Must wait for scan to finish before starting to reset."] = "Du musst warten, bis der Scan fertig ist, bevor du mit dem Zurücksetzen beginnen kannst" -- Needs review
L["Name of New Group to Add Item to:"] = "Name der neuen Gruppe zu der der Gegenstand hinzugefügt werden soll:" -- Needs review
...
L["No Items to Reset"] = "Keine Gegenstände zum Zurücksetzen" -- Needs review
...
L["Not canceling auction below threshold."] = "Breche keine Auktion unter der Preisschwelle ab." -- Needs review
L["Not enough items in bags."] = "Nicht genügend Gegenstände in den Taschen." -- Needs review
L["%% of %s"] = "%% von %s"
...
L["Post Auctions"] = "Erstelle Auktionen" -- Needs review
L["Post cap"] = "Auktionsgrenze" -- Needs review
L["Posting at fallback."] = "Erstelle mit Rückfallpreis." -- Needs review
L["Posting at reset price."] = "Erstelle mit Zurücksetzenpreis." -- Needs review
L["Posting at whitelisted player's price."] = "Erstelle auf Preisniveau des Spielers auf der Whitelist." -- Needs review
L["Posting at your current price."] = "Erstelle mit deinem aktuellen Preis." -- Needs review
L["Posting %s / %s"] = "Erstelle %s / %s" -- Needs review
L["Posting this item."] = "Stelle diesen Gegenstand ein." -- Needs review
L["Post Scan Finished"] = "Erstellen-Scan abgeschlossen" -- Needs review
L["Post Settings (Quantity / Duration)"] = "Auktionsseinstellungen" -- Needs review
L["Posts items on the auction house according to the rules setup in Auctioning."] = "Stellt die Gegenstände im AH, nach den in \"Auctioning\" eingestellten Regeln, ein." -- Needs review
L["Post time"] = "Auktionszeit" -- Needs review
L["Price Per Item"] = "Preis pro Item" -- Needs review
L["Price Per Stack"] = "Preis pro Stapel" -- Needs review
-- L["Price resolution"] = ""
...
L["Processing Items..."] = "Verarbeite Gegentände..." -- Needs review
L["Profiles"] = "Profile" -- Needs review
L["Profit:"] = "Gewinn" -- Needs review
L["Profit Per Item"] = "Gewinn pro Gegenstand" -- Needs review
L["Quantity (Yours)"] = "Menge (Deine)" -- Needs review
...
L["Reset Auctions"] = "Auktionen Zurücksetzen" -- Needs review
L["Reset Method"] = "Methode des Zurücksetzens" -- Needs review
L["Reset Profile"] = "Profil zurücksetzen"
L["Reset Scan Finished"] = "Zurücksetzen-Scan fertig" -- Needs review
L["Reset Scan Settings"] = "Einstellungen des Zurücksetzen-Scans" -- Needs review
L["Resets the price of items according to the rules setup in Auctioning by buying other's auctions and canceling your own as necessary."] = "Setzt den Preis von Gegenständen, nach den Einstellungen bei \"Auctioning\", durch das Aufkaufen fremder Auktionen und dem Abbrechen deiner eigenen (sofern nötig), zurück." -- Needs review
...
L["Return to Summary"] = "Zurück zur Zusammenfassung" -- Needs review
L["Right-Click to add %s to your friends list."] = "Rechtsklick um %s zu deiner Freundesliste hinzuzufügen." -- Needs review
L["Right click to do a custom cancel scan."] = "Rechtsklick um einen benutzerdefinierten Abbrechen-Scan durchzuführen." -- Needs review
L["Right click to do a custom post scan."] = "Rechtsklick um einen benutzerdefinierten Erstellen-Scan durchzuführen." -- Needs review
L["Right click to do a custom reset scan."] = "Rechtsklick um einen benutzerdefinierten Zurücksetzen-Scan durchzuführen." -- Needs review
...
L["Running Scan..."] = "Scan läuft..." -- Needs review
L["Save New Price"] = "Speichere den neuen Preis" -- Needs review
L["Scanning"] = "Scanne"
L["Scanning Item %s / %s"] = "Scanne Gegenstände %s / %s" -- Needs review
...
L["Shift-Right-Click to show the options for this item's Auctioning group."] = "Shift-Rechtsklick um die Optionen für die Auktionsgruppe dieses Gegenstandes zu zeigen." -- Needs review
L["Short (30 minutes)"] = "Kurz (30 Minuten)" -- Needs review
L["short (less than 30 minutes)"] = "Kurz (weniger als 30 Minuten)" -- Needs review
L["Show All Auctions"] = "Zeige alle Auktionen" -- Needs review
L["Show group name in tooltip"] = "Gruppenname im Tooltip anzeigen" -- Needs review
L["Show Item Auctions"] = "Auktionen des Gegenstandes anzeigen" -- Needs review
L["Show Log"] = "Log anzeigen" -- Needs review
...
L["Smart canceling"] = "Schlaues abbrechen" -- Needs review
L["Smart group creation"] = "Schlaue Gruppen Erstellung" -- Needs review
...
L["Start Scan of Selected Groups"] = "Scan der gewählten Gruppen starten" -- Needs review
L["Stop Scan"] = "Scan stoppen" -- Needs review
...
L["The maximum amount that you want to spend in order to reset a particular item. This is the total amount, not a per-item amount."] = "Die maximale Summe, die du ausgeben möchtest um ein bestimmtes Item zurückzusetzen. Dies ist die Gesamtsumme, nicht die Summe pro Item." -- Needs review
L["The minimum profit you would want to make from doing a reset. This is a per-item price where profit is the price you reset to minus the average price you spent per item."] = "Der minimale Gewinn, den du durch ein Zurücksetzen erwirtschaften möchtest. Dies ist der Preis pro Item, während Profit der Preis ist, auf den zurück gesetzt wird abzüglich der durchschnittlichen Summe, die du dafür pro Item ausgeben musst." -- Needs review
...
L["This controls how many times Auctioning will retry a query before giving up and moving on. Each retry takes about 2-3 seconds."] = "Dies setzt fest wie oft Auctioning versucht einen Gegenstand einzustellen, bevor es zum nächsten springt. Jeder Versuch benötigt ca. 2-3 Sekunden." -- Needs review
L["This determines what size range of prices should be considered a single price point for the reset scan. For example, if this is set to 1s, an auction at 20g50s20c and an auction at 20g49s45c will both be considered to be the same price level."] = "Dies bestimmt welche Preisspanne als einzelner Preispunkt im Zurücksetzenscan gewertet werden soll. Wenn z.B. 1s eingestellt ist, werden Auktionen mit 20g50s20c und 20g49s45c als eine Preisebene gewertet." -- Needs review
...
L["This is the maximum amount you want to pay for a single item when reseting."] = "Die maximale Summe, die du für einen einzelnen Gegenstand während des Zurücksetzens ausgeben möchtest." -- Needs review
L["This is the maximum number of items you're willing to buy in order to perform a reset."] = "Die maximale Menge der Gegenstände die du bereit bist zu kaufen, um einen Preis zurückzusetzen." -- Needs review
L["This item does not have any seller data."] = "Dieser Gegestand hat keine Verkäuferdaten." -- Needs review
L["This item is already in the \"%s\" Auctioning group."] = "Der Gegenstand ist bereits in der Auktionsgruppe \"%s\"." -- Needs review
L["This item will not be included in the reset scan."] = "Der Gegenstand wird bei einem Zurücksetzen-Scan nicht berücksichtigt." -- Needs review
L["Threshold:"] = "Preisschwelle:" -- Needs review
-- L["Threshold/Fallback:"] = ""
L["Time Left"] = "Verbleibende Zeit" -- Needs review
L["Toggle this box to enable / disable all groups in this category."] = "Anhaken um alle Gruppen in dieser Kategorie zu aktivieren/deaktivieren." -- Needs review
L["Total Cost"] = "Gesamtkosten" -- Needs review
L["TSM_Auctioning Group to Add Item to:"] = "TSM_Auctioning Gruppe der der Gegenstand hinzugefügt werden soll:" -- Needs review
...
L["Undercutting competition."] = "Unterbiete Konkurrenz." -- Needs review
L["Up"] = "Hoch" -- Needs review
L["Use per auction as cap"] = "Den \"Pro Auktion\"-Wert als Grenze verwenden" -- Needs review
L["Use the checkboxes to the left to select which groups you'd like to include in this scan."] = "Nutze die Kontrollkästchen auf der linken Seite um festzulegen, welche Gruppen du in diesem Scan einschließen möchtest." -- Needs review
...
L["You can set a fixed min reset price, or have it be a percentage of some other value."] = "Du kannst einen festen minimal Preis, einen Prozentwert, oder einen anderen Wert beim Zurücksetzen festlegen." -- Needs review
L["You can set a fixed threshold, or have it be a percentage of some other value."] = "Du kannst einen festen Wert, einen Prozentwert, oder einen anderen Wert als Preisschwelle festlegen." -- Needs review
...
L["You don't any groups set to be included in a reset scan."] = "Du hast keine Gruppen für den Zurücksetzen-Scan ausgewählt." -- Needs review
L["You don't any groups set up."] = "Du hast keine Gruppen erstellt." -- Needs review
L["Your auction has not been undercut."] = "Deine Auktion wurde nicht unterboten." -- Needs review
