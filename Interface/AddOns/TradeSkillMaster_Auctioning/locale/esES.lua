...
L["A category contains groups with similar settings and acts like an organizational folder. You may override default settings by category (and then override category settings by group)."] = "Una categoría contiene grupos con ajustes y actos similares a los de una carpeta de organización. Puede anular la configuración predeterminada por categoría (y luego reemplazar la configuración de categoría por grupo." -- Needs review
...
L["Add category"] = "Añadir categoría." -- Needs review
...
L["Add group"] = "Añadir grupo." -- Needs review
-- L["Add Item to New Group"] = ""
-- L["Add Item to Selected Group"] = ""
-- L["Add Item to TSM_Auctioning"] = ""
L["Add player"] = "Añadir jugador." -- Needs review
-- L["Add/Remove"] = ""
L["Add/Remove Groups"] = "Añadir/Eliminar Grupos." -- Needs review
L["Add/Remove Items"] = "Añadir/Eliminar Objetos." -- Needs review
-- L["Advanced"] = ""
...
L["Are you SURE you want to delete this category?"] = "Está seguro de querer eliminar esta categoría?" -- Needs review
L["Are you SURE you want to delete this group?"] = "Está seguro de querer eliminar este grupo?" -- Needs review
...
L["<Uncategorized Groups>"] = "<Grupos sin categoria>" -- Needs review
