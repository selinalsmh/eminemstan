...
L["Are you SURE you want to delete all the groups in this category?"] = "你确定你要删除此类别中的所有组吗？" -- Needs review
...
L["At fallback price and not undercut."] = "回跌价，并不是竞争价。" -- Needs review
L["Auction Buyout"] = "拍卖行一口价" -- Needs review
L["Auction Buyout (Stack Price):"] = "拍卖行一口价（堆叠）：" -- Needs review
L["Auction Defaults"] = "拍卖行默认" -- Needs review
L["Auction has been bid on."] = "竞标已被接受。" -- Needs review
...
L["Buyout"] = "一口价" -- Needs review
L["Buyout:"] = "一口价：" -- Needs review
L["Cancel"] = "取消" -- Needs review
L["Cancel ALL Current Auctions"] = "取消所有目前拍卖" -- Needs review
L["Cancel Auctions"] = "取消拍卖" -- Needs review
L["Cancel Auctions Matching Filter"] = "取消匹配滤波器的拍卖" -- Needs review
L["Cancel auctions with bids"] = "取消只使用竞标价发布的拍卖." -- Needs review
L["Cancel Filter"] = "取消过滤" -- Needs review
L["Canceling"] = "取消中" -- Needs review
L["Canceling all auctions."] = "取消所有拍卖。" -- Needs review
L["Canceling auction which you've undercut."] = "取消拍卖，你需要竞价。" -- Needs review
L["Canceling %s / %s"] = "取消 %s / %s" -- Needs review
L["Canceling to repost at higher price."] = "取消拍卖以以一个更高的价格发布。" -- Needs review
L["Canceling to repost at reset price."] = "取消拍卖以以一个重置的价格发布。" -- Needs review
L["Cancel Low Duration Auctions"] = "取消段时间的拍卖。" -- Needs review
L["Cancels auctions you've been undercut on according to the rules setup in Auctioning."] = "取消该拍卖，因为根据设定你已经被其他人竞价。" -- Needs review
L["Cancel Scan Finished"] = "取消拍卖扫描完毕。" -- Needs review
L["Cancel to repost higher"] = "取消以更高价格发布。" -- Needs review
L["Categories / Groups"] = "分类/分组" -- Needs review
L["Category name"] = "分类名" -- Needs review
L["Category Overrides"] = "覆盖分类" -- Needs review
L["Cheapest auction below threshold."] = "低于门槛价格的拍卖。" -- Needs review
L["Check this box to include this group in the scan."] = "选中此复选框以使扫描的时候包括本组。" -- Needs review
L["Click on the \"Fix\" button to have Auctioning turn this group into a category and create appropriate groups inside the category to fix this issue. This is recommended unless you'd like to fix the group yourself. You will only be prompted with this popup once per session."] = "点击“修复”按钮，让Auctioning为分组内的商品，单独设定为分组，以解决拍卖价格设定不兼容的问题。推荐修复，除非你想手动设定分组。您每次扫描这个分组的时候都会弹出提示。" -- Needs review
--[==[ L[ [=[
Click to reset this item to this target price.]=] ] = "" ]==]
L["Click to reset this item to this target price."] = "点击以目标价格重置该商品的价格。" -- Needs review
--[==[ L[ [=[
Click to show auctions for this item.]=] ] = "" ]==]
L["Click to show auctions for this item."] = "点击显示这个物品的拍卖。" -- Needs review
L["Common Search Term"] = "常用的搜索词" -- Needs review
...
L["Could not find item's group."] = "找不到物品的组。" -- Needs review
...
L["Delete All Groups In Category"] = "删除类别中的所有组" -- Needs review
L["Delete all groups inside this category. This cannot be undone!"] = "在这个类别中删除所有组。这是不能撤消！" -- Needs review
L["Delete a Profile"] = "删除一个配置文件" -- Needs review
L["Delete category"] = "删除类别" -- Needs review
...
L["Disable All"] = "全部禁用" -- Needs review
...
L["First Tab in Group / Category Settings"] = "首要的选项卡组/类别设置" -- Needs review
...
Effective for posting prices in a sane price range when someone is posting an item at 5000g when it only goes for 100g.]=] ] = [=[如果市场价格高于门槛价*最高价，商品将被以门槛价*最高价格发布。

当一个人想以5000g发布一个其实只值100g的商品的时候，让商品以一个正常的价格发布。]=] -- Needs review
...
L["Plays the ready check sound when a post / cancel scan is complete and items are ready to be posting / canceled (the gray bar is all the way across)."] = "在扫描完 准备发布/取消发布 的商品的时候，播放检查完成的声音特效。" -- Needs review
...
L["Your auction has not been undercut."] = "未被压价" -- Needs review
L["You've been undercut."] = "已被压价" -- Needs review
