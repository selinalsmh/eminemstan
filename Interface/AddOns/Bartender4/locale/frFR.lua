...
L["Configure the Extra Action Bar"] = "Configurer la barre d'actions supplémentaire" -- Needs review
...
L["Enable the Extra Action Bar"] = "Activer la barre d'actions supplémentaire" -- Needs review
...
L["Hide this bar when a override bar is active."] = "Cacher cette barre quand une barre de substitution est active." -- Needs review
