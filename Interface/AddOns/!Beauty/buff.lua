...
growthhorizontal = 2    -- Growth Direction. 1 = left, 2 = right
...
buffholder:Point("TOPLEFT", UIParent, "TOPLEFT",  10, -7)--buffholder:Point("TOPRIGHT", UIParent, "TOPRIGHT",  -30, -7)
...
debuffholder:Point("TOPLEFT", UIParent, "TOPLEFT", 10, -145)---debuffholder:Point("TOPRIGHT", UIParent, "TOPRIGHT", -30, -145)
...
enchantholder:Point("BOTTOMLEFT", Minimap, "BOTTOMLEFT", 0, -40)
...
local function StyleBuffs(button, index, framekind, anchor)
    ...
    if framekind == 3 then
    	_G[buff.."Count"]:SetFont(C.fontbuff, 10, "OUTLINE")
    	_G[buff.."Duration"]:SetFont(C.fontbuff, 10, "OUTLINE")
    	_G[buff]:Height(buttonsize - 8)
		_G[buff]:Width(buttonsize - 8)
    else
		_G[buff.."Count"]:SetFont(C.fontbuff, 14, "OUTLINE")
   		_G[buff.."Duration"]:SetFont(C.fontbuff, 14, "OUTLINE")
