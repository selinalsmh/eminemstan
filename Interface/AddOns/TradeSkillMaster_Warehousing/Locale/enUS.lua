...
L["Crafting"] = true
L["Auctioning"] = true
L["Auctioning Categories"] = true
L["Auctioning Groups"] = true
...
L["to ensure consistent results.  If you feel then need you can adjust this.  The timeout can be no less than "] = true
L["one second and no greater then five.  Be warned I make no promises if you do decide to adjust this.  You have been warned."] = true
