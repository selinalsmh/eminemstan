...
ns.font = "Fonts\\ARKai_T.ttf"
ns.fontsize = 12
ns.fontflag = "OUTLINE"
local positions = {
    player_buff_icon = {"CENTER", UIParent, "CENTER", -200, 0},	-- "玩家buff&debuff"
    target_buff_icon = {"CENTER", UIParent, "CENTER", 200, 0},	-- "目标buff&debuff"
    player_proc_icon = {"CENTER", UIParent, "CENTER", 200, 50},	-- "玩家重要buff&debuff"
    target_proc_icon = {"CENTER", UIParent, "CENTER", -200, 50},	-- "目标重要buff&debuff"
    focus_buff_icon = {"CENTER", UIParent, "CENTER", -400, 100},	-- "焦点buff&debuff"
    cd_icon = { "LEFT", UIParent, "LEFT", 5,0  },	-- "cd"
    player_special_icon = {"CENTER", UIParent, "CENTER", -200, -50}, -- "玩家特殊buff&debuff"
	...
	player_buff_direction = "RIGHT",
	target_buff_direction = "LEFT",
	CD_buff_direction = "LEFT",
}
ns.watchers ={
        ["DRUID"] = {
            {
                name = "玩家buff&debuff",
                direction = positions.player_buff_direction,
            ...
            {
                name = "目标buff&debuff",
                direction = positions.target_buff_direction,
            ...
            },
            {
                ...
                size = 24,
                mode = "BAR",
                iconSide = positions.player_buff_direction,
                barWidth = 170,
            ...
            {
                name = "CD",
                iconSide = positions.CD_buff_direction,
                size = 28,
                barWidth = 170,
                direction = "DOWN",
                mode = "BAR",
        ...
        ["ROGUE"] = {
            {
                name = "玩家buff&debuff",
                direction = positions.player_buff_direction,--positions.target_buff_direction,
                setpoint = positions.player_buff_icon,
                size = 28,
            ...
            {
                name = "玩家重要buff&debuff",
                direction = positions.player_buff_direction,--positions.player_buff_direction,
                setpoint = positions.player_proc_icon,
                size = 38,
        ...
        ["ALL"]={
            ...
            },
            {
                ...
                --血液腐化:大地
                { spellID = 106200, unitId = "player", caster = "all", filter = "DEBUFF" },
                --血液腐化:死亡
                { spellID = 106199, unitId = "player", caster = "all", filter = "DEBUFF" },
                --死亡之翼的狂亂
                --腐化寄生體
