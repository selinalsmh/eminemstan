...
L["Configure the Extra Action Bar"] = "Configure la barre d'actions extra." -- Needs review
...
L["Enable the Extra Action Bar"] = "Active la barre d'actions extra." -- Needs review
...
L["Extra Action Bar"] = "Barre d'actions extra" -- Needs review
L["Fade Out"] = "Fondu"
