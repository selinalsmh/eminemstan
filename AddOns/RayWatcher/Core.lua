...
local normal = "Interface\\AddOns\\Media\\Statusbar"--"Interface\\Addons\\RayWatcher\\media\\statusbar"
...
function watcherPrototype:CreateButton(mode)
	...
	if mode=="BAR" then
		...
		button.name:SetFont("Fonts\\ARKai_C.ttf", ns.fontsize, ns.fontflag)
