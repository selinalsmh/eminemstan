...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusBL:SetPoint("BOTTOMLEFT", self.Health, 0, -3)
        ...
        self.AuraStatusBR:SetPoint("BOTTOMRIGHT", self.Health, 4, -3)
        ...
        self.AuraStatusCen:SetPoint("TOP", 14, 4) --Hot计时数字
        self.AuraStatusCen:SetJustifyH("CENTER")
        self.AuraStatusCen:SetFont("Fonts\\ARKai_C.ttf", 9, "OUTLINE") --(ns.db.fontPath, ns.db.fontsizeEdge, ns.db.outline)
