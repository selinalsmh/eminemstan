...
function EmbedSkada()
	if #windows == 1 then
		EmbedWindow(windows[1], 250, 138/bars - barSpacing, 155, "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -170, 30)
	elseif #windows == 2 then
		EmbedWindow(windows[1], 270, 140/bars - barSpacing, 140, "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -170, 30)
